...
<body>
	<section>
		...
		<div class="content">
			<SI:Button ID="Button6" Text="Hello" IconPosition="Right" runat="server">
				<span>With children</span></SI:Button>
		</div>
	</section>
	<section>
		<header>
		...
		<div class="content">
			<SI:Grid Summary="a short table summary" Caption="Caption" ID="TableView1" runat="server">
				<Columns>
					...
					<SI:Column DataField="Col2" runat="server" Width="200" OnPreRender="Format"/>
					<SI:Column DataField="Col3" runat="server" Width="90" OnPreRender="Format"/>
					<SI:Column DataField="Col4" runat="server" OnPreRender="Format"/>
					<SI:Column ID="Column1" runat="server">Text content</SI:Column>
				</Columns>
				<EmptyTemplate>
